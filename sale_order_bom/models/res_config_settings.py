...
class ResConfigSettings(models.TransientModel):
    ...
    invoice_hide_bom_items = fields.Boolean(
        related="company_id.invoice_hide_bom_items",
        string="Ocultar ítems BOM",
        readonly=False,
    )
    invoice_hide_cero_price = fields.Boolean(
        related="company_id.invoice_hide_cero_price",
        string="Ocultar ítems con precio cero",
        readonly=False,
    )
    sale_order_add_bom_prefix = fields.Boolean(
        related="company_id.sale_order_add_bom_prefix",
        string="Agregar prefijo BOM",
        readonly=False,
    )
